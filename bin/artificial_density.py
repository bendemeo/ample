...
if __name__ == '__main__':
    ...
    gsGridTests = ['max_min_dist', 'time', 'kmeans_ami',
                   'lastCounts', 'maxCounts', 'remnants', 'rare', 'kl_divergence']
    ...
    randomGridTests = ['max_min_dist', 'time', 'kmeans_ami',
                       'lastCounts', 'maxCounts', 'remnants', 'rare', 'kl_divergence']
    ...
    cosTests = ['max_min_dist', 'time', 'kmeans_ami', 'lastCounts',
                'maxCounts', 'remnants', 'rare', 'kl_divergence']
    ...
    projTests = ['max_min_dist', 'time', 'kmeans_ami', 'lastCounts',
                 'maxCounts', 'remnants', 'rare', 'kl_divergence']
    ...
    Tests = ['max_min_dist', 'time', 'kmeans_ami', 'lastCounts',
             'maxCounts', 'remnants', 'rare', 'kl_divergence']
